...
# TODO: Your code here
xr.open_mfdataset("pet_2020.nc")
xr.open_mfdataset("srad_2020.nc")
xr.open_mfdataset("vpd_2020.nc")
...
# from the full `ds`
#TODO: Your code here
subset_ds = ds.isel(lon=slice(20,40), lat=slice(0,30))
subset_ds
#%%
# Step 9:
...
# 
# TODO: Your code here
stuff = np.corrcoef(spatial_mean_ds['potential_evapotranspiration'],spatial_mean_ds['mean_vapor_pressure_deficit'])
stuff
# %%
# Step 13:
